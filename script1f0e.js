...
if(goblinSong.paused){goblinSong.play()}else{goblinSong.pause()}}
function awaken(){site.classList.add("awake")
goblinSong.src="https://goblintown.wtf/audio/GT-song.mp3"
...
goblinSong.play()
setTimeout(function(){enterButton.remove()},2000);}
volumeButton.onclick=function(){togglePlay()}}
window.addEventListener("load",async()=>{await delay(3)
awaken()
await delay(3)
allowEntry()
psst.onclick=function(){document.getElementById("Family").src="https://www.goblintown.wtf/i/GT-elevin-ekselent-eediots.png";}})